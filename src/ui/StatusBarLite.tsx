...
export default function StatusBarLite(){
  ...
  useEffect(()=>{
    ...
    const t = (globalThis as any).setInterval(()=>Battery.getBatteryLevelAsync().then(l=>setBat(Math.round((l??0)*100))), 30000);
    return ()=>{ unsubN(); (globalThis as any).clearInterval(t); };
  },[]);
