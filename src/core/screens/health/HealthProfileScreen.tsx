        ...
        return (
          ...
          <TextInput
            ...
            <TextInput
              ...
              <View style={styles.formRow}>
                <Text style={styles.label}>Sigorta Bilgileri</Text>
                <View style={styles.row}>
                  <View style={styles.halfInput}>
                    <TextInput
                      style={styles.input}
                      placeholder="Sigorta Kurumu"
                      placeholderTextColor={colors.text.tertiary}
                  ...
                  <View style={styles.halfInput}>
                    <TextInput
                      style={styles.input}
                      placeholder="Sigorta No"
                      placeholderTextColor={colors.text.tertiary}
                      value={formData.insuranceNumber}
                      onChangeText={(text) => setFormData(prev => ({ ...prev, insuranceNumber: text }))}
                      maxLength={50}
                    />
                  </View>
                </View>
